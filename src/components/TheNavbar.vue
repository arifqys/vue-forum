      ...
      <ul v-if="user">
        <li class="navbar-user" v-click-outside="closeUserDropdown">
          <a @click.prevent="userDropdownOpen = !userDropdownOpen">
            ...
            <span>
                {{user.name}}
                <img class="icon-profile" src="../assets/img/arrow-profile.svg">
            </span>
          </a>
        ...
        <li @click.prevent="mobileNavOpen = !mobileNavOpen" class="navbar-mobile-item"><router-link :to="{name: 'Profile'}">View Profile</router-link></li>
        <li @click.prevent="mobileNavOpen = !mobileNavOpen" class="navbar-mobile-item"><a @click.prevent="$store.dispatch('auth/signOut')">Sign Out</a></li>
      </ul>
      <ul v-else>
        <li @click.prevent="mobileNavOpen = !mobileNavOpen" class="navbar-item">
