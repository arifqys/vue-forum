    ...
    <div class="profile-card">
      ...
      <div class="form-group">
        ...
        <template v-if="$v.activeUser.username.$error">
          ...
          <span v-if="!$v.activeUser.username.unique" class="form-error">This username is already taken</span>
        </template>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input v-model="activeUser.website" @blur="$v.activeUser.website.$touch()" autocomplete="off" class="form-input" id="user_website">
      ...
      <div class="form-group">
        ...
        <template v-if="$v.activeUser.email.$error">
          ...
          <span v-if="!$v.activeUser.email.email" class="form-error">This in not a valid email address</span>
          <span v-if="!$v.activeUser.email.unique" class="form-error">This email has been registered</span>
        </template>
      </div>
      <div class="form-group">
