      ...
      <form @submit.prevent="register" class="card card-form">
        ...
        <div class="form-group">
          ...
          <template v-if="$v.form.name.$error">
            <span v-if="!$v.form.name.required" class="form-error">The field is required</span>
          </template>
        </div>
        <div class="form-group">
          ...
          <template v-if="$v.form.username.$error">
            <span v-if="!$v.form.username.required" class="form-error">The field is required</span>
        ...
        <div class="form-group">
          ...
          <template v-if="$v.form.email.$error">
            <span v-if="!$v.form.email.required" class="form-error">The field is required</span>
            <span v-if="!$v.form.email.email" class="form-error">This is not a valid email address</span>
            <span v-if="!$v.form.email.unique" class="form-error">This email has been registered <router-link :to="{name: 'SignIn'}">Try to Sign in?</router-link></span>
          </template>
        </div>
        <div class="form-group">
          ...
          <template v-if="$v.form.password.$error">
            <span v-if="!$v.form.password.required" class="form-error">The field is required</span>
